...
- 一轮回复产生之后，用脚本给telegram bot发消息提示我，方法为 `python scripts/notify_telegram_job_done.py --message "message content"`。消息内容为"prompt: {我的prompt}\nresponse summary: {本次回复的总结}"。总结应当用中文，并且不应当超过50个汉字。
